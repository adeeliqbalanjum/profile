...
document.querySelectorAll('.project-card,.service-item,.process-step,.hero-card').forEach((card) => {
  card.addEventListener('mousemove', (e) => {
    ...
    card.style.background = `radial-gradient(circle at ${x}px ${y}px, rgba(90,147,244,.20), transparent 32%), linear-gradient(135deg, rgba(255,255,255,.46), rgba(255,255,255,.20))`;
  });
